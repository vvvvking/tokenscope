/**
 * TokenScope proxy — parser.mjs
 *
 * Node-side version of the usage extractors. Identical semantics to the
 * browser hook, but exposed as ES modules and reading Node-native strings.
 *
